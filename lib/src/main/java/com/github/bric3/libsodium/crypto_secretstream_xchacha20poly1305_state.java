...
public class crypto_secretstream_xchacha20poly1305_state {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(32, C_CHAR).withName("k"),
        MemoryLayout.sequenceLayout(12, C_CHAR).withName("nonce"),
        MemoryLayout.sequenceLayout(8, C_CHAR).withName("_pad")
